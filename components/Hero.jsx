  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div
        ...
        style={{ top: "10%", left: "10%", opacity: 0.12 }}
      />
      <div
      ...
      />
      <div
        className="orb w-64 h-64 bg-gold-400"
        style={{ top: "50%", right: "30%", opacity: 0.06 }}
      />
      ...
      <div
        ref={heroRef}
        className="section-animate relative z-10 max-w-4xl mx-auto text-center"
      >
        {/* Slogan */}
        ...
        <h1 className="text-5xl md:text-7xl font-black leading-tight mb-6 tracking-tight">
          Rakipleriniz Büyürken
          <br />
          <span className="gradient-text glow-text">Siz Neden Bekliyorsunuz?</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="#hizmetler"
            className="px-8 py-4 rounded-xl border border-white/10 text-gray-300 font-semibold text-base hover:bg-white/5 hover:border-white/20 transition-all duration-200"
          >
            Hizmetlerimizi Gör
          </a>
        </div>
        ...
        <div className="mt-16 flex flex-wrap justify-center items-center gap-8 text-gray-500 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>Yönetilen Reklam Bütçesi</span>
          </div>
          <div className="w-px h-4 bg-white/10" />
          <div className="flex items-center gap-2">
            <span className="text-gold-400 font-bold text-lg">%340</span>
            <span>Ortalama ROI Artışı</span>
          </div>
        </div>
      </div>
