...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <span className="hidden sm:block bg-white text-gray-800 text-sm font-semibold px-4 py-2 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
        WhatsApp&apos;tan Yaz
      </span>
      ...
      <div className="relative group">
        ...
        <div className="relative w-14 h-14 bg-green-500 hover:bg-green-400 rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 hover:shadow-green-400/50 hover:scale-110 transition-all duration-200">
          {/* WhatsApp Icon */}
          <svg
            viewBox="0 0 24 24"
